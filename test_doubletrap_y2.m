...
%     c = -8/9; d = 2;
    ...
    fprintf('For the function y^2, the theoretical error of the trapezoidal rule can be estimated using its known second \n derivatives, which are constants (fxx = 2, fyy = 0).\n');
    fprintf('The theoretical error, based on the second derivatives (fxx = 0, fyy = 2), reflects the upper bound of the \n actual error, and should typically be larger than the actual error observed in practice.\n');
    ...
    fprintf('The error is given by: ((d-c)^3 / (12*n^2)) * fyy for y^2, since fyy equals zero and does not contribute.\n');
