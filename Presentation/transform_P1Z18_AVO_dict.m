...
%          1 lub 2, dokładniej przekształcenie 1 jest określone
%          wykorzystaniem współżędnych x, y, gdzie
...
[...
    ...
    min_f,... 
    grid_size...
] = doubletrap(@(u, v) transformed_function(u, v, f, r, t_m), fpp, n, m, -1, 1, -1, 1);
end % function